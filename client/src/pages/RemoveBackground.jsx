      ...
      <form onSubmit={onSubmitHandler} className='w-full md:w-1/2 p-6 bg-zinc-900 rounded-xl border border-zinc-700 shadow-lg'>
        ...
        <div className='space-y-6'>
          ...
          <button 
            ...
            className={`w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-3 text-sm rounded-lg transition-all hover:shadow-lg hover:shadow-orange-500/20 ${
